...
// Esta página está disponible para Admin y Viewer
...
$sql = "SELECT
        ...
        ORDER BY uploaded_requirements DESC, approved_requirements ASC;
    ";
                ...
                <tbody>
                    <?php while ($fila = $resultado->fetch_assoc()) { ?>
                        <tr>
                            ...
                            <td class="acciones">
                                <a href="../PHP/Validar_Validacion_Academica_Admin.php?id=<?= $fila['Id_Matricula'] ?>" class="btn amarillo">
                                    <i class='bx bx-task'></i> Validar
                                </a>
                            </td>
                        </tr>
                    <?php } ?>
