...
<header class="top-header">
    ...
    <div class="bottom-header">
        ...
        <p>Consulta de forma detallada los datos de cada usuario registrado.</p>
    </div>
</header>
        ...
        <section class="Contenedor_Form">
            <form action="">
                ...
                <div class="content_button">
                    <a class="btn rojo" href="Validacion_Academica.php">Regresar <i class='bx bx-redo bx-flip-horizontal'></i></i></a>
                </div>
            </form>
        </section>
    </div>
